...
define(['basis', 'ludorum'], function (basis, ludorum) {
	...
	verifier.test("tournaments.AllAgainstAll() with games.Choose2Win() & players.RandomPlayer()", function () { /////////////////
		var game = new games.Choose2Win(),
			...
			contest = new tournaments.AllAgainstAll(game, participants, 2);
